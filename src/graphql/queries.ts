...
export function getProjectByUUIDQuery(uuid:string): string { return `query { project(projectUuid: "${uuid}") { success errors project { name description uuid repositories { uuid url name description } }}}`; }
