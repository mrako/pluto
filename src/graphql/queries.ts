...
export function getUserLinksQuery(): string { return 'query { userLinks { success errors links { uuid organisation { name dataOrigin } projectUser { username dataOrigin } } } }'; }
